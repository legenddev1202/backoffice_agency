...
function Component() {
	...
	useEffect(() => {
		...
		if (!_.isEmpty(widgets) && !_.isEmpty(main) && state.bonusPlan !== '') {
			if (widgets.Projections_Custom_Commisison_Table) {
				widgets = {
					...widgets,
					Projections_Custom_Commisison_Table: {
						...widgets.Projections_Custom_Commisison_Table,
						table: {
							...widgets.Projections_Custom_Commisison_Table.table,
			...
			if (widgets.Projections_Default_Agency_Income_Report_Production_Table) {
				...
				const avgCommission = 'Year 1 Commission per Item(Custom)';
					...
					<div className="flex items-center justify-center p-12">
						...
						>
							<Table
								md
								tableName="AVERAGES"
								data={data.widgets.Projections_Custom_Commisison_Table}
