...
function ContactDialog(props) {
	...
	const contactDialog = useSelector(({ addbonusPlanTemplate }) => addbonusPlanTemplate.autoBonus.targetBonusDialog);
	const showAutoTargetAmount = useSelector(
		({ addbonusPlanTemplate }) => addbonusPlanTemplate.autoBonus.showAutoTargetAmount
	);
	const showFireTargetAmount = useSelector(
		({ addbonusPlanTemplate }) => addbonusPlanTemplate.autoBonus.showFireTargetAmount
	);
	const showLifeTargetAmount = useSelector(
		({ addbonusPlanTemplate }) => addbonusPlanTemplate.autoBonus.showLifeTargetAmount
	);
	const showHealthTargetAmount = useSelector(
		({ addbonusPlanTemplate }) => addbonusPlanTemplate.autoBonus.showHealthTargetAmount
	);
	const showBankTargetAmount = useSelector(
		({ addbonusPlanTemplate }) => addbonusPlanTemplate.autoBonus.showBankTargetAmount
	);
	...
	function closeComposeDialog() {
		return contactDialog.type === 'edit' ? dispatch(closeEditTargetBonusDialog()) : dispatch(closeNewTargetBonusDialog());
	}
